  ...
  return (
    ...
    <div className={classes.root}>
      <div style={{textAlign: 'center'}}>
        ...
        <h3> Hear from out members about the power of Toastmasters</h3>
        </div>
      <Grid container spacing={3}>
        <Grid item xs={4} className="col-">
          ...
          <img src={shaq} alt='shaquilla' className={classes.image}></img>
              <p className={classes.text}>Joining Toastmasters 18 months ago has had such a postive effect on me. I am a far more eloquent, competent and creative speaker; and during the Covid-19 pandemic and having all communications move to video calls, I have become more flexible and versatile in my style. 
        ...
        <Grid item xs={4} className="col-">
          ...
          <img src={fedor} alt='fedor' className={classes.image}></img>
               <p className={classes.text}>I have benefitted so much from being a member of Toastmasters.  Firstly, the skills I acquired gave me the confidence to accept a job that required frequent public speaking appearances. Secondly, I have gained evaluation skills that
        ...
        <Grid item xs={4} className="col-">
          ...
          <img src={pippa} alt='pippa' className={classes.image}></img>
              <p className={classes.text}> I am what you might call a “legacy” in that my mum was a Toastmaster for many years. I am following in her footsteps as well as forging my own path.  For me, TM has allowed me to practice speaking in a safe environment and try out

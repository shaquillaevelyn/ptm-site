      ...
      <section className=" margin-section-lg about-body">
        <div className="text">
          ...
          <p className="body-text-lg">
            ...
            build your confidence, public speaking and communication skills.
            Whether you are a complete newbie or a seasoned public speaker, you
            are welcome to join us at our meetings where we can improve
            together.
          </p>
          <br />
